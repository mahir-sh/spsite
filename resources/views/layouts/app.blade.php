...
<html lang="en">
   <head>
      ...
      <!-- fonts -->
      <link href="assets/https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;700&display=swap" rel="stylesheet">
      <!-- font awesome css -->
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="assets/index.html"><img src="images/logo.png"></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
                        <a class="nav-link" href="assets/index.html">Home</a>
                     </li>
                     <li class="nav-item">
                                 ...
                                 <div class="col-md-6">
                                    <div class="social_icon">
                                       <ul>
                                          ...
                                          <li><a href="assets/#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
      ...
      <div class="services_section layout_padding">
         ...
         <div class="container">
            <div class="services_section_2">
               ...
               <div class="readmore_bt"><a href="assets/#">Read More</a></div>
            </div>
         </div>
      </div>
      ...
      <div class="portfolio_section layout_padding">
         <div class="container">
                     ...
                     <div class="col-md-8">
                        <div class="container_main">
                           ...
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="assets/#">See More</a></div>
                                 </div>
                              </div>
                           </div>
                        </div>
            ...
            <div class="seemore_bt"><a href="assets/#">See More</a></div>
         </div>
      </div>
      ...
      <div class="blog_section layout_padding">
         ...
         <div class="blog_section_2">
            <div class="container">
               ...
               <div class="readmore_bt_1"><a href="assets/#">Read More</a></div>
            </div>
         </div>
      </div>
      <!-- blog section end -->
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="mail_section_1">
                        ...
                        <div class="send_bt"><a href="assets/#">Send Now</a></div>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="project_box">
         <div class="container">
            <div class="project_main">
               ...
               <div class="callnow_bt"><a href="assets/#">Call Now</a></div>
            </div>
         </div>
      </div>
